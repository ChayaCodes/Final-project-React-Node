    ...
    return (
        <div>
            <div style={{
                ...
                backgroundImage: "url('/images/homePageHigh.png')", backgroundSize: "cover",
                backgroundPosition: "center", marginTop: "-10vh"
            }}>
                <div style={{ position: "absolute", right: "5vw", bottom: "5vh" }} >
                    <h1 >“ציטוט או אמרה חכמה  <br />של מישהו מוכר שקשור לתחום”</h1>
                    <div>
                        <Button variant="contained" color="secondary" style={{ borderRadius: "20px", marginLeft: "10px" }}>מעבר להדרכות <FontAwesomeIcon icon={faArrowLeft} size="sm" color="#000" /></Button>
                        <Button
                            variant="contained"
                            color="tertiary"
                            style={{
                        ...
                        >
                            הצטרפות לקהילה <FontAwesomeIcon icon={faArrowLeft} color="white" size="sm" />
                        </Button>
                    </div>
                </div>
            </div>
